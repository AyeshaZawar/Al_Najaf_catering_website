  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "relative h-[70vh] min-h-[460px] md:h-[560px] w-full overflow-hidden", children: [
      /* @__PURE__ */ jsxs("div", { className: "absolute inset-0", children: [
        /* @__PURE__ */ jsx("img", { src: section2, alt: "Elegant wedding table setup", className: "h-full w-full object-cover animate-slow-zoom" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative z-10 h-full flex flex-col items-center justify-center px-6 text-center text-white", children: [
        /* @__PURE__ */ jsx(motion.h1, { initial: {
          ...
          duration: 0.9
        }, className: "font-serif-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl tracking-[0.05em]", children: "WEDDING MENU" }),
        ...
        }, className: "mt-6 flex items-center gap-3 text-[11px] sm:text-xs tracking-[0.3em]", children: ["HOME", "MENUS", "WEDDING MENU"].map((c, i, arr) => /* @__PURE__ */ jsxs(motion.span, { variants: {
          hidden: {
            opacity: 0,
            y: 8
          },
