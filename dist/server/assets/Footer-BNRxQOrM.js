    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-[1.4fr_0.8fr_0.8fr] gap-16 items-start", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-6 mt-12", children: [
          /* @__PURE__ */ jsx("a", { href: "https://www.facebook.com/share/14Tjr6ZvdpS/", className: "hover:text-[#D89B4D] transition", children: /* @__PURE__ */ jsx(Facebook, { size: 18 }) }),
          /* @__PURE__ */ jsx("a", { href: "#", className: "hover:text-[#D89B4D] transition", children: /* @__PURE__ */ jsx(Linkedin, { size: 18 }) }),
          /* @__PURE__ */ jsx("a", { href: "https://www.instagram.com/al_najaf_caterers_and_pakwan?igsh=MWJndDBxaXpuNWp2MQ==", className: "hover:text-[#D89B4D] transition", children: /* @__PURE__ */ jsx(Instagram, { size: 18 }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
