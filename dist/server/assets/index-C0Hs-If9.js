...
import { s as section2, N as Navbar, F as Footer } from "./social_event-UVYSfmWr.js";
...
import { s as section3, d as dining } from "./weddings-BxtxYCSt.js";
import { g as g4 } from "./menu-4-BsHtazAQ.js";
import "@tanstack/react-router";
const bg = "/assets/hero-bg-BoEWfl8i.jpg";
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative z-10 text-center px-6 max-w-5xl pt-28", children: [
          ...
          /* @__PURE__ */ jsxs(
            motion.h1,
            {
              ...
              className: "font-serif text-6xl sm:text-7xl md:text-8xl lg:text-[8.5rem] leading-[0.98]",
              children: [
                "CREATION OF",
                /* @__PURE__ */ jsx("br", {}),
                "MEMORABLE",
...
const aboutSmall = "/assets/about-small-BSCGxgPY.jpg";
const aboutTall = "/assets/about-tall-CYF1-pGe.jpg";
function About() {
  return /* @__PURE__ */ jsx(
    "section",
    {
...
const m2 = "/assets/corporate-IZWrgjev.jpg";
const section4 = "/assets/parties-DN30KZ0J.jpg";
const sections = [
  {
    image: m2,
    circleImage: m2,
...
const g2 = "/assets/menu-1-pV-uTG8e.jpg";
const cards = [
  {
    img: g2,
    title: "RELIGIOUS\nMENU",
...
function VideoBanner() {
  return /* @__PURE__ */ jsx("section", { id: "Video", children: /* @__PURE__ */ jsxs("section", { className: "relative h-[70vh] min-h-[480px] overflow-hidden", children: [
    /* @__PURE__ */ jsx("div", { className: "absolute inset-0 zoom-slow", children: /* @__PURE__ */ jsx("img", { src: reserve, alt: "", className: "w-full h-full object-cover" }) }),
...
const g3 = "/assets/menu-3-BT0ni9P_.jpg";
const imgs = [reserve, g2, g3, g4];
function Gallery() {
...
function Reserve() {
  return /* @__PURE__ */ jsx("section", { id: "contact", className: "relative bg-cream-dark py-28 lg:py-36", children: /* @__PURE__ */ jsxs("div", { className: "max-w-[1280px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-14 items-stretch", children: [
    /* @__PURE__ */ jsx(Reveal, { y: 20, children: /* @__PURE__ */ jsx("div", { className: "h-full overflow-hidden rounded-md luxe-shadow", children: /* @__PURE__ */ jsx("img", { src: reserve, alt: "Elegant table", className: "w-full h-full min-h-[560px] object-cover" }) }) }),
    /* @__PURE__ */ jsxs(Reveal, { delay: 0.2, y: 20, children: [
      ...
      /* @__PURE__ */ jsxs("form", { className: "mt-9 grid grid-cols-1 sm:grid-cols-2 gap-4", onSubmit: (e) => e.preventDefault(), children: [
        /* @__PURE__ */ jsx("input", { className: `${inputCls} sm:col-span-2`, placeholder: "Your Name*" }),
        /* @__PURE__ */ jsx("input", { className: inputCls, placeholder: "Phone Number*" }),
        /* @__PURE__ */ jsx("input", { className: inputCls, placeholder: "Email", type: "email" }),
        /* @__PURE__ */ jsx("input", { className: inputCls, placeholder: "Company" }),
        /* @__PURE__ */ jsxs("select", { className: inputCls, defaultValue: "", children: [
          /* @__PURE__ */ jsx("option", { value: "", disabled: true, children: "Event Type" }),
          /* @__PURE__ */ jsx("option", { children: "Wedding" }),
          /* @__PURE__ */ jsx("option", { children: "Corporate" }),
          /* @__PURE__ */ jsx("option", { children: "Religious" }),
          /* @__PURE__ */ jsx("option", { children: "Party" })
        ] }),
        /* @__PURE__ */ jsx("input", { className: inputCls, placeholder: "mm/dd/yyyy", type: "date" }),
        /* @__PURE__ */ jsx("input", { className: inputCls, placeholder: "Number of Guests*", type: "number" }),
        /* @__PURE__ */ jsx("textarea", { className: `${inputCls} sm:col-span-2 min-h-[120px] resize-none`, placeholder: "Wishes / questions / requests" }),
        /* @__PURE__ */ jsxs("button", { className: "group sm:col-span-2 justify-self-start inline-flex items-center gap-3 rounded-full bg-brown-deep hover:bg-gold hover:text-brown-deep transition-all duration-500 px-8 py-4 text-[11px] tracking-[0.28em] text-cream", children: [
          "SUBMIT REQUEST ",
          /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4 transition-transform duration-500 group-hover:translate-x-1.5" })
        ] })
      ] })
    ] })
  ] }) });
