  ...
  return /* @__PURE__ */ jsx("section", { id: "AboutUs", children: /* @__PURE__ */ jsxs("div", { className: "font-sans-lux bg-cream text-brown-deep overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "relative h-screen w-full overflow-hidden", children: [
      /* @__PURE__ */ jsx(motion.div, { initial: {
        ...
        backgroundImage: `url(${aboutSmall})`
      } }),
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-cream py-24 px-6 lg:px-10 relative", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center", children: [
      /* @__PURE__ */ jsxs(motion.div, { initial: "hidden", whileInView: "show", viewport: {
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-brown/70 text-xs tracking-[0.3em] font-semibold mb-6", children: [
      ...
      /* @__PURE__ */ jsxs(motion.div, { initial: "hidden", whileInView: "show", viewport: {
        ...
        /* @__PURE__ */ jsx("div", { className: "overflow-hidden rounded-3xl shadow-2xl", children: /* @__PURE__ */ jsx("img", { src: DINING_IMG, alt: "Luxury dining", className: "w-full h-[480px] object-cover hover:scale-110 transition-transform duration-1000" }) }),
    ...
    /* @__PURE__ */ jsxs("section", { className: "relative h-[80vh] w-full overflow-visible flex items-center justify-center", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-cover bg-center md:bg-fixed", style: {
    ...
    /* @__PURE__ */ jsxs("section", { className: "relative pt-56 pb-32 overflow-visible", children: [
      ...
      /* @__PURE__ */ jsx(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsx("div", { className: "absolute left-1/2 -top-16 -translate-x-1/2", children: /* @__PURE__ */ jsx("img", { src: g1, alt: "Wedding", className: "w-32 h-32 md:w-40 md:h-40 object-cover shadow-2xl" }) }),
        /* @__PURE__ */ jsx("h2", { className: "font-serif-lux text-4xl md:text-6xl leading-[1.1] text-[#4B2E14]", children: "UNFORGETTABLE CATERING FOR ANY OCCASION!" }),
